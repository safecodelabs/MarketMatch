...
const { generateFollowUpQuestion } = require('../src/ai/aiEngine');
  ...
  switch (cmd) {
    ...
    case "restart":
      return {
        ...
        nextSession: { ...session, step: "start", housingFlow: { step: "start", data: {} } }
      };
    ...
    case "post_command":
      // Start the 'post' flow dynamically
      ...
      return {
        reply: { type: "text", text: { body: question || "Please provide your listing details." } },
    ...
    case "buy":
      ...
      return {
        reply: { type: "text", text: { body: buyQuestion || "Which location or budget are you looking for?" } },
    ...
    case "sell":
      ...
      return {
        reply: { type: "text", text: { body: sellQuestion || "Please provide property details to post." } },
        nextSession: { ...session, housingFlow: sellSession }
      };

    default:
      return {
        reply: { type: "text", text: { body: "Unknown command. Try 'Menu' to see options." } },
        nextSession: session
      };
  }
}
...
/**
 * Map user input text to explicit command
 */
